...
int main(int argc, char** argv) {
  if (argc < 3 || argc > 4) {
    cout << "Usage: " << argv[0]
         << " <XCLBIN> <packet_file> [prefilter.bitset]" << endl;
  ...
  if (!bitset_file.empty()) {
    ...
    if (!bf.read(reinterpret_cast<char*>(bitset_data.data()),
      ...
      cerr << "ERROR: failed to read prefilter bitset: " << bitset_file
           << endl;
      return EXIT_FAILURE;
    }
    bf.close();
  ...
  cout << "  Note: Bloom table was loaded from the input buffer prefix." << endl;
